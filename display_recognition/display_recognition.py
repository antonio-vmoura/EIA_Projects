...
def base64_to_image(base64_content):
    encoded_data = base64_content.split(',')[1]
...
def recognize_display(path_image, qty_decimal_digit=2, source="base64"):
    ...
    final = final_result(digits, qty_decimal_digit)

    return final

def handler(img, decimalQty):
    print("Inicio da funcao")

    digits = recognize_display(path_image=img, qty_decimal_digit=decimalQty)
